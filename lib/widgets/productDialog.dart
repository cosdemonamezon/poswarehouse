                                                ...
                                                cells: <DataCell>[
                                                  ...
                                                  DataCell(SizedBox(
                                                    ...
                                                    child: widget.allProduct!.data![index].image != null
                                                        ? Image.network('${widget.allProduct!.data![index].image}',
                                                            fit: BoxFit.fill)
                                                        : Image.asset(
                                                  ...
                                                  DataCell(Center(
                                                      child:
                                                          Text('${widget.allProduct!.data![index].price_for_retail}'))),
                                                  DataCell(Center(
                                                      child: Text(
                                                          '${widget.allProduct!.data![index].price_for_wholesale}'))),
                                                  DataCell(Center(
                                                      child: Text('${widget.allProduct!.data![index].price_for_box}'))),
                                                  DataCell(
