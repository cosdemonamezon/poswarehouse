                                                          ...
                                                          cells: <DataCell>[
                                                            ...
                                                            DataCell(InkWell(
                                                                onTap: () async{
                                                                  ...
                                                                  if (selectPrice != null) {
                                                                    setState(() {
                                                                      listneworder[index].price_per_unit = int.parse(selectPrice);
                                                                    });
                                                                    inspect(listneworder);
                                                                  } else {
                                          ...
                                          try {
                                            for (var i = 0; i < listneworder.length; i++) {
                                              ...
                                              await context.read<ProductController>().createNewOrder(
                                                datePick!.text, name!.text, phone!.text, email!.text, address!.text, radioButtonItem, listneworder
                                              );
                                    ...
                                    child: GestureDetector(
                                      onTap: () async {
                                        if (textPriceController.text != "") {
                                          ...
                                          try {
                                            LoadingDialog.open(context);
                                            await context.read<ProductController>().confirmNewOrder(controller.orderProduct!.order_no!, int.parse(textPriceController.text));
