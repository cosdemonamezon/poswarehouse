...
class OrdersApi {
  ...
  static Future<StockPurchase> createOrders(String date, List<NewOrders> orders) async {
    final url = Uri.https(publicUrl, '/pos/public/api/stock_purchase');
  ...
  static Future<Purchase> pickupOrders(String stock_purchase_no, List<Damageds> damageds) async {
    final url = Uri.https(publicUrl, '/pos/public/api/receive_stock_purchase');
    var headers = {'Content-Type': 'application/json'};
    final response = await http.post(
      url,
      headers: headers,
  ...
  static Future<PurchaseOrders> getOrderById(String stock_purchase_no) async {
    final url = Uri.https(publicUrl, '/pos/public/api/get_stock_purchase_line/$stock_purchase_no');
    var headers = {'Content-Type': 'application/json'};
