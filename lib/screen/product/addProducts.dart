...
class _AddProductsState extends State<AddProducts> {
  ...
  Future<void> categoryinitialize() async {
    ...
    setState(() {
      categoryValue =
          context.read<CategoryController>().allTypeProduct!.data![0];
    });
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            controllerCategory.allTypeProduct != null
                                ? controllerCategory
                                        .allTypeProduct!.data!.isNotEmpty
                                    ? Container(
                                        height: size.height * 0.08,
                                        width: size.width * 0.45,
                        ...
                        onTap: () async {
                          if (image != null &&
                            ...
                            final _create = await ProductApi.createProduct(
                                ...
                                sub_category_id: dropdownValue!.id.toString());
                            if (_create != null) {
                              LoadingDialog.close(context);
