...
class CategoryApi {
  ...
  static Future<List<TypeProduct>> getCategorys() async {
    final url = Uri.http(publicUrl, '/pos-api/public/api/category_product_page');
  ...
  static Future<TypeProduct> getCategorysById(int? idCategorys) async {
    ...
    final url = Uri.http(publicUrl, 'pos-api/public/api/category_product/$idCategorys');
  ...
  static Future<TypeProduct> crateCategorys(String name) async {
    final url = Uri.http(publicUrl, '/pos-api/public/api/category_product');
    var headers = {'Content-Type': 'application/json'};
    final response = await http.post(
      url,
      headers: headers,
...
// แก้ประเภทสินค้า
  Future<bool> changeTitleCatagory(
    ...
    final url = Uri.http(publicUrl, '/pos-api/public/api/category_product/$catagoryId');
