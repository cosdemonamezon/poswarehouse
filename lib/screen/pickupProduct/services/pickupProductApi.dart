...
class PickupProductApi {
  ...
  static Future<AllReceiving> getPickups({
    ...
    final url = Uri.http(publicUrl, '/pos-api/public/api/stock_pickout_page');
  ...
  static Future<ReceivingGoods> getPickupsById(String stock_pick_out_no) async {
    final url = Uri.http(publicUrl, '/pos-api/public/api/get_stock_pickout_line/$stock_pick_out_no');
    var headers = {'Content-Type': 'application/json'};
  ...
  static Future<StockPurchase> receiveStock(String stock_pick_out_no) async {
    final url = Uri.http(publicUrl, '/pos-api/public/api/receive_stock_pickout');
    var headers = {'Content-Type': 'application/json'};
    final response = await http.post(
      url,
      headers: headers,
  ...
  static Future<ReceivingGoods> getReturnProduct(String stock_purchase_no) async {
    final url = Uri.http(publicUrl, '/pos-api/public/api/get_stock_purchase_damaged/$stock_purchase_no');
    var headers = {'Content-Type': 'application/json'};
    final response = await http.get(
      url,
      headers: headers,
